...
---[Official Documentation](https://modding.desyncedgame.com/#ui)
UI = {}

---Register a layout definition tag
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-register)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-isregistered)
---@param p1 string Layout tag name
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-new)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-addlayout)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-makemodoptionswidget)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-getscreensize)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-menupopup)
---@param p1 widget Widget
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-closemenupopup)
---@returns boolean # If a popup was actually closed
function UI.CloseMenuPopup() end

---Close the current tooltip
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-closetooltip)
function UI.CloseTooltip() end

---Refresh the current tooltip
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-refreshtooltip)
function UI.RefreshTooltip() end

---Play a UI sound effect, music, voice or ambience
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-playsound)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-stopmusic)
function UI.StopMusic() end

---Stop the playing voice
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-stopvoice)
function UI.StopVoice() end

---Stop the playing ambience sound effect
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-stopambiencesound)
function UI.StopAmbienceSound() end

---Hide the entire UI
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-setuihidden)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-isuihidden)
---@returns boolean # UI hidden state
function UI.IsUIHidden() end

---Query the UI coordinate of an entity in the game camera view
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-entitylocationonscreen)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-run)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-getmouseposition)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#ui-ismouseoverui)
