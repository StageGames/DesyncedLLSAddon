...
---[Official Documentation](https://modding.desyncedgame.com/#twitch)
Twitch = {}
...
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-login)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-logout)
function Twitch.Logout() end

---Check if the user is logged in on Twitch
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-isloggedin)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-getuserdata)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-getcustomrewards)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-startrewards)
function Twitch.StartRewards() end

---Stop listening for reward redemptions
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-stoprewards)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-startchat)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#twitch-stopchat)
