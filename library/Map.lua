...
---[Official Documentation](https://modding.desyncedgame.com/#map)
Map = {}

---Modify simulation speed
---
---[Official Documentation](https://modding.desyncedgame.com/#map-setgamespeed)
---@param p1 integer Game speed
function Map.SetGameSpeed(p1) end

---Get simulation speed
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getgamespeed)
---@returns integer # Game speed
function Map.GetGameSpeed() end

---Check if LUA is currently running in simulation context
---
---[Official Documentation](https://modding.desyncedgame.com/#map-issimulation)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-isfrontend)
---@returns boolean # True if front-end
function Map.IsFrontEnd() end

---Get current map settings (read only)
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getsettings)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-modifysettings)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getseed)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getsave)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-run)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-dropitemat)
...
---Get a faction
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getfaction)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-createfaction)
---@param p1 string Faction id
...
---Get all factions
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getfactions)
---@returns table # List of faction objects
function Map.GetFactions() end

---Get the number of spawned player faction
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getplayerfactioncount)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-gettotaldays)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getsunlightintensity)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getsunlightamount)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getsunlightdirection)
---@returns integer # Sunlight Y direction
function Map.GetSunlightDirection() end

---Get the day time of sunrise and sunset
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getsunriseandsunset)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getundiscoveredlocation)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-spawnchunks)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getblightness)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getelevation)
---@param p1 area|point|entity Location to check
---@param p2 boolean|nil If checking more than a single tile, return the smallest value instead of the biggest (OPTIONAL, default false)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getrichness)
---@param p1 area|point|entity Location to check
---@param p2 boolean|nil If checking more than a single tile, return the smallest value instead of the biggest (OPTIONAL, default false)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getvariation)
---@param p1 area|point|entity Location to check
---@param p2 boolean|nil If checking more than a single tile, return the smallest value instead of the biggest (OPTIONAL, default false)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getheight)
---@param p1 area|point|entity Location to check
---@param p2 boolean|nil If checking more than a single tile, return the smallest value instead of the biggest (OPTIONAL, default false)
...
---Get plateau height
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getplateauheight)
---@returns integer # plateau height
function Map.GetPlateauHeight() end

---Get water height
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getwaterheight)
---@returns integer # water height
function Map.GetWaterHeight() end

---Get table with full tile data for a given location
---
---[Official Documentation](https://modding.desyncedgame.com/#map-gettiledata)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-defer)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-delay)
...
---Start terraforming
---
---[Official Documentation](https://modding.desyncedgame.com/#map-startterraforming)
...
---End terraforming
---
---[Official Documentation](https://modding.desyncedgame.com/#map-stopterraforming)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getentityat)
---@param p1 integer X coordinate
---@param p2 integer Y coordinate
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getfoundationentityat)
---@param p1 integer X coordinate
---@param p2 integer Y coordinate
---@returns entity|nil # Entity (or nil if none)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-getentitiesat)
---@param p1 integer X coordinate
---@param p2 integer Y coordinate
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-findclosestentity)
...
---
---[Official Documentation](https://modding.desyncedgame.com/#map-throwitemeffect)
