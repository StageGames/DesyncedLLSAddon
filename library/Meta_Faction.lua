...
function Faction.Unlock(p1, p2) end
...
function Faction.GetPowerGrid(p1) end
...
function Faction.GetPowerGridIndexAt(p1) end
...
function Faction.GetPowerHistory(p1, p2) end
...
function Faction.GetItemHistory(p1, p2, p3) end
...
function Faction.GetItemAmount(p1) end
...
function Faction.GetItemAvailability(p1) end
...
function Faction.GetItemTotals(p1) end
...
function Faction.GetActiveOrders() end
...
function Faction.OrderTransfer(p1, p2, p3, p4, p5) end
...
---@returns boolean # Return true if successful and false if the source doesn't hold the item amount or the target can't receive it
function Faction.OrderTransfer(p1, p2, p3) end
...
function Faction.CanPlace(p1, p2, p3, p4, p5, p6, p7) end
...
function Faction.IsVisible(p1, p2) end
...
---@returns boolean # Result of check
function Faction.IsDiscovered(p1, p2) end
...
---@returns boolean # Result of check
function Faction.IsSeen(p1) end
...
function Faction.FindClosestHiddenTile(p1, p2, p3, p4) end
...
function Faction.OrderEntitiesToMoveAway(p1, p2) end
...
function Faction.GetComponents(p1, p2) end
...
function Faction.GetEntitiesWithComponent(p1, p2, p3) end
...
function Faction.GetVisibleEntities(p1) end
...
function Faction.GetTrust(p1) end
