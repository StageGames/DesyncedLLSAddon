...
function Entity.Place(p1, p2, p3, p4) end
...
---@returns boolean|nil # Returns boolean false if failed to place, otherwise nil
function Entity.Place(p1, p2, p3) end
...
function Entity.AddComponent(p1, p2, p3) end
...
function Entity.GetComponent(p1) end
...
function Entity.SwapSockets(p1, p2) end
...
---@returns Component|nil # Component object or nil if not exist
function Entity.GetHiddenComponent(p1) end
...
function Entity.CountComponents(p1) end
...
function Entity.FindComponent(p1, p2, p3) end
...
function Entity.GetFreeSocket(p1) end
...
function Entity.CheckSocketSize(p1, p2) end
...
function Entity.GetRegister(p1) end
...
function Entity.GetRegisterLinks(p1) end
...
function Entity.GetRegisterNum(p1) end
...
function Entity.GetRegisterId(p1) end
...
function Entity.GetRegisterDef(p1) end
...
function Entity.GetRegisterEntity(p1) end
...
function Entity.GetRegisterCoord(p1) end
...
function Entity.RegistersEqual(p1, p2) end
...
function Entity.RegisterIsLink(p1) end
...
function Entity.RegisterIsEmpty(p1) end
...
function Entity.RegisterIsError(p1) end
...
function Entity.RegisterHasConnection(p1, p2, p3) end
...
function Entity.GetRegisterLinkSource(p1) end
...
---@returns Component|nil # Component that holds the source register or nil if frame register (unless entity/component specified)
function Entity.GetRegisterLinkSource(p1, p2) end
...
function Entity.GetRegisterLinkTarget(p1, p2) end
...
function Entity.AddItem(p1, p2, p3) end
...
function Entity.CountItem(p1, p2) end
...
function Entity.HaveFreeSpace(p1, p2) end
...
function Entity.CountFreeSpace(p1) end
...
function Entity.GetFreeSlot(p1, p2) end
...
function Entity.GetSlot(p1) end
...
function Entity.FindSlot(p1, p2) end
...
function Entity.AddSlots(p1, p2) end
...
function Entity.AutoMergeSlots(p1) end
...
function Entity.IsWaitingForOrder(p1) end
...
function Entity.TransferFrom(p1, p2, p3, p4) end
...
function Entity.OrderItem(p1, p2, p3) end
...
function Entity.IsTouching(p1) end
...
function Entity.IsInRangeOf(p1, p2) end
...
function Entity.GetRangeTo(p1) end
...
function Entity.GetRangeSquaredTo(p1) end
...
function Entity.DockInto(p1) end
...
function Entity.PlayEffect(p1, p2, p3, p4) end
...
function Entity.SetVisual(p1, p2) end
...
function Entity.AddHealth(p1) end
...
function Entity.RemoveHealth(p1, p2) end
